...
class MultipleChoiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        MultipleChoice::create([
            'question_type' => 'pusat',
            'question' => 'Berikut merupakan aset dalam bentuk persediaan, kecuali…',
            'question_explanation' => 'Persediaan adalah aset lancar dalam bentuk barang atau perlengkapan yang dimaksudkan untuk mendukung kegiatan operasional pemerintah, dan barang-barang yang dimaksudkan untuk dijual dan/atau diserahkan dalam rangka pelayanan kepada masyarakat. Persediaan merupakan aset berwujud: 
            ...
            Konstruksi dalam pengerjaan masuk dalam klasifikasi aset tetap yang meliputi aset dalam proses pembangunan namun pada tanggal laporan keuangan belum selesai seluruhnya.',
            'answer_a' => 'Barang yang digunakan dalam rangka kegiatan operasional pemerintah',
            'answer_b' => 'Konstruksi dalam pengerjaan',
            'answer_c' => 'Barang yang digunakan dalam proses produksi',
            'answer_d' => 'Barang yang dimaksudkan untuk dijual/diserahkan kepada masyarakat',
            'correct_answer' => 'b',
        ]);
        MultipleChoice::create([
            'question_type' => 'pusat',
